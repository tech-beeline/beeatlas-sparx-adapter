...
select 
	...
	--,
	--(select value from t_connectortag o where o.property='operation_guid' and elementid=msg.connector_id limit 1 ) as operation_guid
from d_tree
...
where d_tree.e2e_uid='{AD0F73D8-87B1-41ed-AD5A-61DC188466D7}'