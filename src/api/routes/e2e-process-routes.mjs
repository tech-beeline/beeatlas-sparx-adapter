...
import SWAGGER, { E2E_LIST_RESOURCE, E2E_MESSAGES_RESOURCE, E2E_RESOURCE } from "../swagger/e2e-process-swagger.mjs";
...
export default {
    routes: [
        ...
        { path: E2E_MESSAGES_RESOURCE, method: "get", controller: controllers.getE2EMessages },
    ], swagger: SWAGGER
}