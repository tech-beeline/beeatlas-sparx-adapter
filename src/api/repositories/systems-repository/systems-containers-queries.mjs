...
export const SELECT_SYSTEM_CONTAINERS_CODE = `${SELECT_SYSTEM_CONTAINERS} AND LOWER(cn.alias)=LOWER($1)`;
export const SELECT_SYSTEM_CONTAINERS_BY_CODES = `${SELECT_SYSTEM_CONTAINERS}  AND LOWER(sys.alias)=LOWER($1) AND LOWER(cn.alias)=LOWER($2)`;