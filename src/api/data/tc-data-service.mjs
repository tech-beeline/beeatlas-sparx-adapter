...
import { APP_PACKAGE_ROOT_GUID, BC_PACKAGE_ROOT_GUID } from './options.mjs';
...
class TechnicalCapabilityDataService {
	/**
	 * 
...
export default new TechnicalCapabilityDataService();