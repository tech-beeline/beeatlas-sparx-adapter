...
export default { APP_CATALOG_ROOT, CONTAINER_STEREOTYPE, API_SPECIFICATION_URL_TAG, APPLICATION_CATALOG_CTE, APPLICATION_QUERY, APPLICATION_INFO_QUERY, APP_PACKAGE_QUERY }