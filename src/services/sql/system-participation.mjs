...
select distinct app.name, app.cmdb, e2e.name as e2e, e2e.ea_guid as e2e_uid
from d_tree
	...
	join t_diagram e2e on e2e.ea_guid=d_tree.e2e_uid and e2e.stereotype='e2e_diagram'
where app.cmdb=$1
`