...
import E2EProcessPage, { E2EProcessSummary_URI } from './Components/dashboards/e2e-process/e2e-process-page.mjs';
...
import E2EProcessesListPage from './e2e/e2e-process-main.mjs';
...
root.render(
  <Router>
    <Routes>
      ...
      <Route path={`${E2EProcessSummary_URI}/:uid`} element={<E2EProcessPage/>} />
      ...
      <Route path={`e2e/:process_uid/bi/:uid`} element={<E2EScenarioDashboard/>} />
    </Routes>
  </Router>
)
/*
